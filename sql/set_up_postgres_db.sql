...
CREATE TABLE IF NOT EXISTS doctor_slot (
    ...
    created_at TIMESTAMP,
    updated_at TIMESTAMP,
    CONSTRAINT fk_doctor_slot_doctor FOREIGN KEY (doctor_id) REFERENCES doctor(doctor_id),
    CONSTRAINT fk_slot_code FOREIGN KEY (slot_code) REFERENCES slot_code_template(slot_code)
);
-- =========================================
-- 6) TABLE: appointment
-- =========================================
CREATE TABLE IF NOT EXISTS appointment (
    ...
    created_at TIMESTAMP,
    updated_at TIMESTAMP,
    CONSTRAINT fk_appointment_slot FOREIGN KEY (slot_id) REFERENCES doctor_slot(slot_id),
...
CREATE TABLE IF NOT EXISTS appointment_status_history (
    ...
    reason TEXT,
    CONSTRAINT fk_appointment_status_history_appointment FOREIGN KEY (appointment_id) REFERENCES appointment(appointment_id)
);
-- =========================================
-- 8) TABLE: payment
-- =========================================
